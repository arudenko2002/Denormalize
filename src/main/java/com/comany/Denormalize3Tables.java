...
public class Denormalize3Tables {
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, String>> set1key1 = p
                .apply(TextIO.read().from("gs://umg-alexey-test/source-directory/streams.gz"))
        ...
        PCollection<KV<String, String>> set2key1 = p
                .apply(TextIO.read().from("gs://umg-alexey-test/source-directory/tracks.gz"))
        ...
        PCollection<KV<String, String>> set3key2 = p
                .apply(TextIO.read().from("gs://umg-alexey-test/source-directory/users.gz"))
        ...
        set_join_1_2_3.apply(TextIO.write().to("gs://umg-alexey-test/destination-directory/streams_denorm.json"));
